...
Each page follows the same shape: what the thing is, what I personally built, the design decisions and why, what the result was, and what I'd change. Design files, firmware, and CAD are downloadable where I'm allowed to share them.
...
Shorter projects worth a mention:

- **Passive battery management system** — group project designing and testing a passive-balancing BMS for a multi-cell pack (EGR 538, Batteries and EV Technologies).
- **Four-wheel-steering vehicle simulation** — modeled and simulated 4WS handling in a vehicle dynamics package (EGR 560, Vehicle Dynamics and Control).
